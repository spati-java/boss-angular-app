...
var ProjectService = (function () {
    function ProjectService(http) {
        this.http = http;
        this.baseUrl = 'http://boss-lb-dev.mbopartners.com/project/api/v1/projects';
    }
    ProjectService.prototype.getAllProjects = function () {
        ...
        return this.http.get(this.baseUrl, options).map(function (res) { return res.json(); });
    };
    ProjectService.prototype.getProjectById = function (id) {
        ...
        var options = new http_1.RequestOptions({ headers: headers });
        var url = 'app/project/project.json' + "/" + '579bcb2aa35f9400010b1b13';
